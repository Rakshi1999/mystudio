       ...
       <div className='outline'>
        ...
        <div className='right-Section'>
            <div className='homeNav'>
                <ul>
                    <li><NavLink to='/mymusic'>All</NavLink></li>
                    <li><NavLink to='/mymusic'>Trending Songs</NavLink></li>
                    <li><NavLink to='/mymusic'>New Songs</NavLink></li>
                    <li><NavLink to='/mymusic'>Old Songs</NavLink></li>
                    <li><NavLink to='/mymusic'>Moods & Genres</NavLink></li>
                    <li><NavLink to='/mymusic'>Album</NavLink></li>
                    <li><NavLink to='/mymusic'>Radio</NavLink></li>
                    <li><NavLink to='/mymusic'>Podcast</NavLink></li>
                    <li><NavLink to='/mymusic'>My Music</NavLink></li>
                </ul>
            </div>
            <div className='wrapper'>
                <span className='left' onClick={scrollHandlerLeft}><AiOutlineCaretLeft /></span>
                ...
                <span className='right' onClick={scrollHandlerRight}><AiOutlineCaretRight/></span>
            </div>
            <div className='trendingPage'>
                <h3 className='Titile'>Trending Songs</h3>
                <div className='trendingWrapper'>
                 <span className='left' onClick={TrendingScrollHandlerLeft}><AiOutlineCaretLeft /></span>
                    <div className='trendingCardsHolder' ref={trendingCarouselRef}>
                        <TrendingCard src={trending3} name="Jelebi" ref={trendingImageRef}/>
                 ...
                 <span className='right' onClick={TrendingScrollHandlerRight}><AiOutlineCaretRight/></span>
                </div>
            </div>
            <div className='artists'>
              <h3 className='Titile'>Artists</h3>
              <div className='trendingWrapper'>
                 <span className='left' onClick={artistScrollHandlerLeft}><AiOutlineCaretLeft /></span>
                    <div className='trendingCardsHolder artistCards' ref={artistCarouselRef}>
                        <TrendingCard src={artist1} name="Neha Kakkar" ref={artistImageRef}/>
                 ...
                 <span className='right' onClick={artistScrollHandlerRight}><AiOutlineCaretRight/></span>
              </div>
            </div>
        </div>
       </div>
